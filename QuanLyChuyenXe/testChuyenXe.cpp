...
void nhapMem(vector<ChuyenXe*>& danhSachXe)
{
...
void xuatDoanhThu(vector<ChuyenXe*> danhSachXe)
{
...

{
	...
	while (true)
	{
		...
		case 2:
		{
			nhapMem(danhSachChuyenXe);
			system("pause");
			break;
		}
		case 3:
		{
			xuatDoanhThu(danhSachChuyenXe);
			system("pause");
			break;
		}

		default:
			cout << "nhap khong dung, moi bann nhap lai ";
			system("pause");
		}
		if (chon == 0)
		{
